...
read_log <- reactive({
  ...
  # check_cols <- colnames(ss_log)
  # 
  # validate(need("deployment_date" %in% check_cols, "ERROR: Column deployment_date not found in log"))
  # validate(need("retrieval_date" %in% check_cols, "ERROR: Column retrieval_date not found in log"))
  # validate(need("sensor_type" %in% check_cols, "ERROR: Column sensor_type not found in log"))
  # validate(need("sensor_serial_number" %in% check_cols, "ERROR: Column sensor_serial_number not found in log"))
