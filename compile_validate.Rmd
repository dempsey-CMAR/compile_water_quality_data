...
output$compile_button <- renderUI({
  actionButton(
    ...
    width = '100%',
    onclick = "location.href='#section-compile-data';")
})
...
output$trim_button <- renderUI({
  req(input$compile)
  actionButton("apply_trim", "Trim", width = '100%',)
})
...
output$val_button <- renderUI({
  ...
  actionButton(
    "apply_val", "Validate", 
    width = '100%',
    onclick = "location.href='#section-validate-sensors';")
})
...
load_data <- eventReactive(input$compile, {
  path <- file_path()
...
selectInput(
  "val_id", 
  "Validation", 
  choices = c("VAL000", "VAL0068", "VAL0069")
)
...
Compile Data {data-icon="fa-table"}
=======================================
...
Validate Sensors {data-icon="fa-check"}
=======================================
