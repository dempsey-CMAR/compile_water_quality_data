...
- **deployment_latitude**: the latitude of the deployed sensors. Must be the same for each row.
- **deployment_longitude**: the longitude of the deployed sensors. Must be the same for each row.
